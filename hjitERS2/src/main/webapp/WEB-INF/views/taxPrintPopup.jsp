...
<%	
	...
	ArrayList<SerialSubVO> listSub = (ArrayList<SerialSubVO>) request.getAttribute("listSub");
	
	if(vom == null){
		vom = new SerialMainVO();
	}
	if(listSub == null){
		listSub = new ArrayList<SerialSubVO>();
	}
			...
			<tr>
				...
				<td>
					<table width="700" border="0" cellspacing="0" cellpadding="0" style="FONT-SIZE: 18pt; FONT-FAMILY: 굴림; Design_Time_Lock: TRue;" id="Table11">
						...
						<tr>
							<td height=10 align=right style="font-size: 8pt;"></td>
						</tr>
						<tr>
					...
					<table width="700" border="0" cellspacing="0" cellpadding="0" style="table-layout: fixed; FONT-SIZE: 9pt; FONT-FAMILY: 굴림; Design_Time_Lock: TRue" ID="Table1">
						...
						<tr>
							<td height="20" align="left" colspan="2">등록번호 : ${vo.cu_adcode}</td>
						...
						<tr>
							...
							<td height="20" align="left" colspan="2">대&nbsp;표&nbsp;자 : ${comInfo.co_master}</td>
						</tr>
						<tr>
							<td height="20" align="left" colspan="2">소&nbsp;재&nbsp;지 : ${vo.cu_juso}</td>
					...
					<table width="700" border="0" cellspacing="0" cellpadding="0" style="table-layout: fixed; FONT-SIZE: 9pt; FONT-FAMILY: 굴림; Design_Time_Lock: TRue" ID="Table2">
						<tr>
							<td height="20" align="center" width="65%" style="border-left: 1px black solid; border-top: 1px black solid; border-bottom: 1px black solid;">선명&nbsp;${listSub[0].ship_vessel}</td>
							<td height="20" align="center" width="35%" style="border-top: 1px black solid; border-right: 1px black solid; border-bottom: 1px black solid;">입항일&nbsp;${listSub[0].ship_arrive}</td>
						</tr>
					</table>
					...
					<table width="700" border="0" cellspacing="0" cellpadding="2" style="FONT-SIZE: 9pt; FONT-FAMILY: 굴림; Design_Time_Lock: TRue; Table-Layout: fixed;" id="Table5">
						...
						<c:forEach var="item" items="${listSub}" varStatus="vs">
						<tr align="center">
							<td height=31 style="border-left: 1px black solid; border-right: 1px black solid;">${listSub[vs.index].ship_contno}  &nbsp;</td>
							<td style="border-right: 1px black solid;">${listSub[vs.index].ship_holddesc} &nbsp;</td>
							<td style="border-right: 1px black solid;">${listSub[vs.index].ship_type} &nbsp;</td>
							<td style="border-right: 1px black solid;">${listSub[vs.index].ship_hold}</td>
							<td style="border-right: 1px black solid;">
								<c:choose>
									<c:when test = "${listSub[vs.index].ship_basedate eq '-'}">
										-
									</c:when>
									<c:otherwise>
										<fmt:parseDate value="${listSub[vs.index].ship_basedate}" var="dateFmt" pattern="yyyyMMdd"/>
							...
							<td style="border-right: 1px black solid;"><fmt:formatNumber value="${listSub[vs.index].ship_qty}" pattern="#,###" /> </td>
							<td style="border-right: 1px black solid;"><fmt:formatNumber value="${listSub[vs.index].ship_rate}" pattern="#,###" /> </td>
							<td style="border-right: 1px black solid;"><fmt:formatNumber value="${listSub[vs.index].ship_amount}" pattern="#,###" /> </td>
						</tr>
      					</c:forEach>
						<tr>
					...
					<table width="700" border="0" cellspacing="0" cellpadding="2" style="table-layout: fixed; FONT-SIZE: 9pt; FONT-FAMILY: 굴림; Design_Time_Lock: TRue" ID="Table2">
						...
						<tr>
							...
							<td height="20" align="right" style="border-top: 1px black solid; border-right: 1px black solid;"><fmt:formatNumber value="${vom.ship_amt}" pattern="#,###" /></td>
						</tr>
						<tr>
							<td height="20" align="left">가상계좌번호 :${vo.cma_account}</td>
							...
							<td height="20" align="right" style="border-top: 1px black solid; border-right: 1px black solid;"><fmt:formatNumber value="${vom.ship_vat}" pattern="#,###" /></td>
						</tr>
						<tr>
							<td height="20" align="left">예금주 :${comInfo.co_saname}</td>
							...
							<td height="20" align="right" style="border-top: 1px black solid; border-right: 1px black solid; border-bottom: 1px black solid;"><fmt:formatNumber value="${vom.ship_tot}" pattern="#,###" /></td>
						</tr>
						<tr>
